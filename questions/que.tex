...
\end{figure}
  ...
  Покажите как будет выглядеть выходное напряжение на таком фильтре? Амплитуда входного сигнала 12В ($ \pm 6V$) Как вы думаете, как оно будет звучать по сравнению с изначальным?
  \begin{figure}[H]
  \centering
