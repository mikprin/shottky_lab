...
\begin{itemize}
  ...
  \item \textbf{Как суметь предугадать проявление диода или омического контакта в соответствующей структуре металл полупроводник?}
...
\begin{itemize}
  ...
  \item \textbf{Когда диод шоттки применять лучше обычного  кремниевого диода?}
  \item \textbf{Когда диод шоттки применять хуже обычного кремниевого диода?}
